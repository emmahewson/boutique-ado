...
ALLOWED_HOSTS = [
    ...
    '8000-emmahewson-boutiqueado-bae3ut9ju24.ws-eu101.gitpod.io',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # makes sure the bag contents are available to all templates
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutique-ado-eh'
